...
async def run_strategy(
    ...
    if is_us_state:
        structured_prompt = (
            ...
            "Suggest an exciting, aspirational brand name rooted in local culture "
            "or state identity (e.g. 'Lone Star Learning' for Texas, 'Grand Canyon Futures' "
            "for Arizona). Avoid generic names like 'State Program' or 'State Education'. "
        ...
        structured_prompt = (
            ...
            "Suggest an exciting, aspirational brand name rooted in local language "
            "or national vision (e.g. 'Ed71' for UAE, 'Savoir France' for France, "
            "'Ru'ya 2030' for Saudi Arabia). Avoid generic names like "
            "'National Program' or '[Country] Education'. "
            "It is OK to say they are 'operated by Alpha'.\n\n"
            "Set partnership_structure to operator_licensor.\n"
